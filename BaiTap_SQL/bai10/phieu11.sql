use master
go
create database QLBH_bai10_phieu11
go
use QLBH_bai10_phieu11
go
...
select * from MatHang
select * from NhatKyHang
insert into NhatKyHang values (2, '2020-12-12', 'as', '2', 200, 500)
drop trigger trg_nhatkybanhang_ktra_update
update NhatKyHang set soluong = soluong - 5 where mahang = 2
select * from MatHang
select * from NhatKyHang
...
select * from MatHang
select * from NhatKyHang
update NhatKyHang set soluong = 430 where mahang = 2
select * from MatHang
select * from NhatKyHang
